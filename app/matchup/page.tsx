...
const CounterNetwork = dynamic(
  () => import("@/components/matchup/CounterNetwork"),
  {
    ssr: false,
    loading: () => (
      <div className="card h-[500px] flex items-center justify-center text-muted">
        加载克制图谱…
      </div>
    ),
  }
